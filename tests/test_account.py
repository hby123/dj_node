...
class dj_nodeSignUpTest(TestCase):
    URL_NAME = "sign-up"
    ...
    def test_signup_get(self):
        ...
        # todo
        #url = "http://%s%s" % (my_domain, img_url)
        #response = c.get(url)
        #self.assertEqual(response.status_code, 200)
...
class dj_nodeLoginTest(TestCase):
    URL_NAME = "login"
...
class dj_nodeLogoutTest(TestCase):
    URL_NAME = "logout"
...
class dj_nodeForgotPasswordTest(TestCase):
    ...
    def test_forgotpassword_post(self):
        ...
        assert "check your email" in  response.content
...
class dj_nodeResetPasswordTest(TestCase):
...
class dj_nodeChangePassowrdTest(TestCase):
    URL_NAME = "login"
